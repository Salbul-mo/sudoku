...
export const MESSAGES = Object.freeze({
    ko: Object.freeze({
        ...
        "learn.progress": "{solved}/{tried}",
        "learn.noProgress": "아직 없음",
        "learn.loading": "문제를 준비하고 있습니다.",
        "learn.askPlacement": "표시된 칸에 들어갈 숫자를 누르세요.",
        "learn.askElimination": "지울 수 있는 후보를 모두 누른 다음 제출하세요.",
        "learn.submit": "제출",
        "learn.next": "다음 문제",
        "learn.correct": "정답입니다.",
        "learn.wrongPlacement": "다시 보세요. 근거를 표시했습니다.",
        "learn.wrongElimination": "지울 후보가 정확히 일치해야 합니다. 근거를 표시했습니다.",
        "learn.marked": "후보 {digit} 표시함",
        "learn.unmarked": "후보 {digit} 표시 해제함",
        "learn.markCount": "{count}개 표시함",
    ...
    en: Object.freeze({
        ...
        "learn.progress": "{solved}/{tried}",
        "learn.noProgress": "not yet",
        "learn.loading": "Finding an exercise.",
        "learn.askPlacement": "Press the digit that belongs in the marked cell.",
        "learn.askElimination": "Press every candidate that can be ruled out, then submit.",
        "learn.submit": "Submit",
        "learn.next": "Next exercise",
        "learn.correct": "That is right.",
        "learn.wrongPlacement": "Look again -- the evidence is marked.",
        "learn.wrongElimination": "The candidates have to match exactly. The evidence is marked.",
        "learn.marked": "candidate {digit} marked",
        "learn.unmarked": "candidate {digit} unmarked",
        "learn.markCount": "{count} marked",
