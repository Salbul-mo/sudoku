...
export const MESSAGES = Object.freeze({
    ko: Object.freeze({
        ...
        "meta.description": "힌트 갯수를 골라 새 퍼즐을 만드는 무료 온라인 스도쿠. 매번 새로 생성되며 정답이 하나뿐인 것이 보장됩니다. 설치 없이 브라우저에서 바로, 키보드와 터치 모두 지원합니다.",
        "meta.ogDescription": "힌트 갯수를 골라 새 퍼즐을 만드는 무료 온라인 스도쿠. 정답이 하나뿐인 것이 보장됩니다.",
        "meta.heading": "스도쿠",
        ...
        "newGame.title": "새 게임",
        "newGame.body": "힌트 갯수를 고르세요. 지금 진행 중인 퍼즐은 사라집니다.",
        "newGame.preset": "{count}개",
    ...
    en: Object.freeze({
        ...
        "meta.description": "A free online Sudoku that builds a new puzzle on every request. Choose how many clues you start with; every puzzle is guaranteed to have exactly one solution. No install, keyboard and touch alike.",
        "meta.ogDescription": "A free online Sudoku that builds a new puzzle every time. Choose your clue count; every puzzle has exactly one solution.",
        "meta.heading": "Sudoku",
        ...
        "newGame.body": "Choose how many clues to start with. The puzzle in progress will be discarded.",
        "newGame.preset": "{count} clues",
